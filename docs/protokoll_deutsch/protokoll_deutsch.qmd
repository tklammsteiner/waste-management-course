...
|---|---|---|
|CO<sub>2</sub> + 4 H<sub>2</sub> --> CH<sub>4</sub> + 2 H<sub>2</sub>O   |-135   |fast alle methanogens    |
|4 HCOOH --> CH<sub>4</sub> + 3 CO<sub>2</sub> + 2 H<sub>2</sub>O    |-130   |fast alle methanogens    |
